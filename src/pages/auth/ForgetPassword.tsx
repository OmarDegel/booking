  ...
  return (
    <div className="w-full min-h-screen">
      <div className="flex flex-col lg:flex-row min-h-screen">
        <div className="hidden lg:flex w-1/2 h-screen bg-yellow-400 items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="w-full lg:w-1/2 h-screen flex items-center justify-center px-6 lg:px-12">
          <div className="w-full max-w-md">
            ...
            <form className="space-y-5">
              ...
              <button className="w-full h-12 bg-yellow-400 text-white rounded-md font-semibold hover:bg-yellow-500">
                Reset Password
              </button>
            </form>
